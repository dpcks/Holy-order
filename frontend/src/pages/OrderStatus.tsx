        ...
        <div className="px-6 py-3 flex gap-2 overflow-x-auto hide-scrollbar bg-white border-b border-gray-50">
          {activeOrders.map((activeOrder) => (
            <button
              ...
              className={`px-4 py-1.5 rounded-full text-[12px] font-black transition-all whitespace-nowrap ${String(activeOrder.id) === String(id)
      ...
      <main className="flex-1 px-4 py-4 flex flex-col items-center gap-5">
        ...
        <div className="w-full bg-white rounded-3xl p-6 shadow-[0_4px_20px_rgba(0,0,0,0.03)] border border-gray-100 flex flex-col items-center gap-4 mt-2">
          <div className="text-center py-2">
            ...
            <div className="inline-flex items-center gap-2.5 bg-gray-50 border border-gray-100 px-6 py-2.5 rounded-full">
              <div className={`w-3 h-3 rounded-full animate-pulse ${isReady || isCompleted ? 'bg-green-500' : isPreparing ? 'bg-primary' : 'bg-orange-400'}`} />
              <span className="text-gray-800 font-black text-[14px] tracking-tight">
